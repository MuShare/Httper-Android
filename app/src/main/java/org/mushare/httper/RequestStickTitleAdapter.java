 ...
 */
public class RequestStickTitleAdapter extends AbstractAdapter implements
    ...
    public long getHeaderId(int position) {
        ...
        //this if is not necessary for your code, we only use it as this sticky header is reused
        // for different item implementations
        ...
        } else if (item instanceof SimpleSubExpandableItem && ((SimpleSubExpandableItem) item)
                .header != null) {
    ...
    public RecyclerView.ViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_header,
                parent, false);
